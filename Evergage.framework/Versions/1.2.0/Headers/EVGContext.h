...
/**
 Register a campaign handler for a host-app-defined target within this context.
 Can set nil to clear.
...
/**
 ...
 Recommended to call just before the context is active/visible, viewWillAppear for a view controller.
...
/**
 Tracks that an line item is being added to the shopping cart.
 
 Recommended to call while the context is active.
