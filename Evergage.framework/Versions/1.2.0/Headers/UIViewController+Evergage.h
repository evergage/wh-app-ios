...
/**
 ...
 See `<evergageScreen>` for access to `<EVGContext>` APIs, and the <Integration> Guide
 for more info about dynamically mapping screens to view actions.
 */
@interface UIViewController (Evergage)

/**
 Provides APIs to track item views and activity, track manual actions, and handle data campaigns for this screen.
...
/**
 ...
 Should be set before viewDidAppear, such as within Interface Builder (Attribute Inspector on the VC) or programmatically in viewDidLoad or viewWillAppear.
 */
